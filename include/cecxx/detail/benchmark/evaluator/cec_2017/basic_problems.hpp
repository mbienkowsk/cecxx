...
#include <cecxx/detail/benchmark/evaluator/legacy/functions/multimodal/bi_rastrigin2017.hpp>
#include <cecxx/detail/benchmark/evaluator/problem_invokers/basic_problem_invoker.hpp>
